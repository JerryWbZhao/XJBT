...
class yhtb1(unittest.TestCase):
    ...
    def test_yhtb1(self):
        ...
        time.sleep(2)
        driver.find_element_by_xpath("//*[@id='username']").send_keys("13100000003")
        ...
        #如果没有找到上面的元素就截取当前页面。
            driver.get_screenshot_as_file("E:\\selenium_use_case\\error_png\\XJBT_yhtb.png")
        ...
        driver.find_element_by_xpath("//*[@id='fullname']").send_keys("新疆吉庆烟花爆竹连锁经营有限公司")
        driver.find_element_by_xpath("//*[@id='enterprise-complete-form']/div[1]/div[2]/div/input").clear()
        driver.find_element_by_xpath("//*[@id='enterprise-complete-form']/div[1]/div[2]/div/input").send_keys("吉庆烟花爆竹")
        ...
        driver.find_element_by_xpath("//*[@id='enterprise-complete-form']/div[3]/div[2]/div/input").send_keys("李四勇")
...
if __name__ == "__main__":
    ...
    suite.addTest(yhtb1("test_yhtb1"))
