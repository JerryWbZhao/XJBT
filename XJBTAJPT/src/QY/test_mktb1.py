...
class mktb1(unittest.TestCase):
    ...
    def test_mktb1(self):
        ...
        driver.find_element_by_xpath("//*[@id='fullname']").send_keys("新疆拜城天辰矿业有限公司鑫源煤矿")
        driver.find_element_by_xpath("//*[@id='enterprise-complete-form']/div[1]/div[2]/div/input").clear()
        driver.find_element_by_xpath("//*[@id='enterprise-complete-form']/div[1]/div[2]/div/input").send_keys("鑫源煤矿")
        ...
        driver.find_element_by_xpath("//*[@id='enterprise-complete-form']/div[3]/div[2]/div/input").send_keys("李二勇")
...
if __name__ == "__main__":
    ...
    suite.addTest(mktb1("test_mktb1"))
