...
class fmtb2(unittest.TestCase):
    ...
    def test_fmtb2(self):
        ...
        driver.find_element_by_xpath("//*[@id='enterprise-license-form']/div[2]/div[1]/div[1]/div[4]/input").send_keys("非煤矿山")
...
if __name__ == "__main__":
    ...
    suite.addTest(fmtb2("test_fmtb2"))
