...
if __name__=='__main__':
    ...
    test_dir = 'E:\\selenium_use_case\\test_case'
    #知道测试报告的路径
    test_report_dir='E:\\selenium_use_case\\test_report'
    ...
    runner = HTMLTestRunner(stream=fp,title=u'新疆兵团安监平台自动化测试报告',description=u'用例执行情况：')
    runner.run(discover)
    #注意：调用函数一定要加括号
    fp.close() 
